...
readmiProducts.forEach((google, index) => {
    ...
    `;
    const googleProductsContainer = document.getElementsByClassName('mobiles-container')[6]; // third index 6
